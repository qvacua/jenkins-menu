...
//
   ...
   #define log4Debug(format, ...) printf("%s", [[NSString stringWithFormat:(@"[DEBUG] %s - %d: " format "\n"), __PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__] UTF8String])
    ...
    #define logPoint4Debug(prefix, point) printf("%s", [[NSString stringWithFormat:@"[DEBUG] %s - %d: %@: %@\n", __PRETTY_FUNCTION__, __LINE__, prefix, [NSValue valueWithPoint:point]] UTF8String])
#endif

#ifndef logSize4Debug
    #define logSize4Debug(prefix, size) printf("%s", [[NSString stringWithFormat:@"[DEBUG] %s - %d: %@: %@\n", __PRETTY_FUNCTION__, __LINE__, prefix, [NSValue valueWithSize:size]] UTF8String])
#endif

#ifndef logRect4Debug
    #define logRect4Debug(prefix, rect) printf("%s", [[NSString stringWithFormat:@"[DEBUG] %s - %d: %@: %@\n", __PRETTY_FUNCTION__, __LINE__, prefix, [NSValue valueWithRect:rect]] UTF8String])
#endif
